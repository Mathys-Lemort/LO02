...
/**
 * Cette classe est responsable de la gestion de l'événement de jouer une carte avec des points dans le jeu.
 * Elle implémente l'interface EventHandler<ActionEvent> pour gérer l'événement de manière appropriée.
 */
public class ControleurJouerPoints implements EventHandler<ActionEvent> {
     ...
     * @param modelePartie L'instance de la classe Partie qui représente le modèle de jeu.
     ...
     * Elle appelle la méthode jouerCartePoints du modèle de jeu et traite le joueur suivant.
     ...
     */
      ...
      * Elle vérifie et réincarne le joueur si nécessaire, pioche une carte pour le joueur,
      ...
      * Elle vérifie si la main et la pile du joueur sont vides, et réincarne le joueur si c'est le cas.
      ...
      * Elle met à jour l'interface du joueur actuel, définit le joueur bot comme joueur actif,
      ...
      * Elle vérifie et réincarne le joueur si nécessaire, pioche une carte pour le joueur,
      * et affiche l'écran du joueur avec son pseudo, sa main, sa pile, sa fosse, sa vie future et ses oeuvres.
